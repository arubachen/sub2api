...
type PromoCodeRepository interface {
	...
	ListWithFilters(ctx context.Context, params pagination.PaginationParams, status, search, allowedEmailSuffix string) ([]PromoCode, *pagination.PaginationResult, error)
