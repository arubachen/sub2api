export default {
  ...
  profile: {
    ...
    changeAvatar: '更换头像',
    removeAvatar: '移除头像',
    avatarHint: '支持 PNG / JPEG / WebP，上传前会先检查类型与大小，并可裁剪为方形头像。',
    avatarInvalidType: '请选择 PNG、JPEG 或 WebP 图片',
    avatarTooLarge: '图片过大，请选择 2MB 以内的文件',
    avatarReadFailed: '读取图片失败，请重试',
    avatarCropTitle: '裁剪头像',
    avatarCropHint: '拖动图片调整位置，使用滑块缩放，保存后会自动裁成方形头像。',
    avatarZoom: '缩放',
    avatarReset: '重置位置',
    avatarApply: '应用裁剪',
    username: '用户名',
  ...
  admin: {
    ...
    users: {
      ...
      totalRecharged: '总充值',
      riskDetail: '风险详情',
      riskDetailTitle: '用户滥用风险详情',
      riskLoadFailed: '加载风险详情失败',
      riskScore: '风险分',
      riskDecision: '决策',
      riskComputedAt: '计算时间',
      riskDerivedOnly: '基于 usage_logs 的近 24 小时行为和历史 IP 指标自动计算，不包含外部 IP 情报。',
      riskWindow24h: '分析窗口',
      riskMetricsTitle: '风险指标',
      riskRequests24h: '24h 请求数',
      riskCost24h: '24h 实际消耗',
      riskKeyCount: 'API Key 数',
      riskFirstIp: '首个 IP',
      riskHistoricalIpCount: '历史 IP 数',
      riskUa24hCount: '24h UA 数',
      riskActiveHoursCount: '活跃小时数',
      riskLongestSilence: '最长静默',
      riskConcurrentMinutes: '同分钟多 IP 多 UA',
      riskHourConcentration: '时段集中度',
      riskAllDayActive: '全天活跃',
      riskActiveHours: '活跃小时',
    ...
    accounts: {
      ...
      types: {
        ...
        soraApiKeyHint: '连接另一个聚流实例或兼容 API',
      ...
      soraUpstreamBaseUrlHint: '上游 Sora 服务地址（另一个聚流实例或兼容 API）',
    ...
    promo: {
      ...
      deleteCode: '删除优惠码',
      searchCodes: '搜索优惠码...',
      filterByAllowedEmailSuffix: '按允许域名筛选...',
      allStatus: '全部状态',
      columns: {
        code: '优惠码',
        bonusAmount: '赠送金额',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于聚流用户登录',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用聚流',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">聚流是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是聚流的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用聚流',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到聚流 AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
