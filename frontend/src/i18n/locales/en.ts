export default {
  ...
  profile: {
    ...
    avatarHint: 'PNG, JPEG, and WebP are supported. Files are checked for type and size before a square crop is applied.',
    avatarInvalidType: 'Please choose a PNG, JPEG, or WebP image',
    avatarTooLarge: 'Image is too large. Please choose a file under 2MB',
    avatarReadFailed: 'Failed to read the image. Please try again',
    avatarCropTitle: 'Crop Avatar',
    avatarCropHint: 'Drag to reposition the image, use the slider to zoom, and save a square avatar.',
    avatarZoom: 'Zoom',
