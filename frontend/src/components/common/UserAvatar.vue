<template>
  <div
    :class="[
      'flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-500 to-primary-600 text-white',
      roundedClass,
      sizeClass,
      shadowClass,
    ]"
...
const safeAvatarUrl = computed(() =>
  sanitizeUrl(props.avatarUrl || '', { allowDataUrl: true, allowRelative: false }),
)
